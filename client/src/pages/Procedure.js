...
function Procedure() {
  ...
  let instrArr = !procedures
    ? [{ title: "No Entries to List", text: "No Entries Found" }]
    : procedures[0].instructions;
  return (
        ...
        <Carousel.Item>
          <div id="block" className="steps">
            <Container fluid>
              ...
              <StepCard
                title="Kudos to keeping it clean"
                text="Time to remove the gloves."
              />
            </Container>
